  ...
  if (y >= 2520 && y <= 2600 && x >= 0 && x <= 90){
    ...
    if (FR == 255) {
      if (!npcResponseBox) {
        ...
        npcResponseBox.position(710, 500);
        ...
        npcResponseBox.style("width", "535px"); // Change this to fit your needs
        npcResponseBox.style("height", "130px"); // Change this to fit your needs
